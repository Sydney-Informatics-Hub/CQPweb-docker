		...
		<table class="concordtable fullwidth">
			...
			<tr>
				<td class="concordgrey" colspan="2">
					...
					<p class="spacer">&nbsp;</p>
					<p>
						Please note that some email systems may flag the verification email as spam. If you do not recieve an email after a few minutes, please check your spam inbox.
					<p class="spacer">&nbsp;</p>
					<p>
